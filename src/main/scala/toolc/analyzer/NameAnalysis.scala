  ...
  def run(ctx: Context)(prog: Program): Program = {
    ...
    def collectSymbols(prog: Program): GlobalScope = {
      ...
      for (c <- prog.classes) {
        ...
        val newClass = new ClassSymbol(c.id.value).setPos(c.file, c.line)
        global.lookupClass(c.id.value) match {
          case Some(className: ClassSymbol) => ctx.reporter.error("Duplicated class name !", newClass)
          case None =>
        ...
        if (!alreadyDoneClasses.contains(c.id.value)) {
          ...
          global.lookupClass(c.id.value) match {
            ...
            case Some(cl) =>
              ...
              for (function <- c.methods) checkMethodOverrides(cl, function)
      ...
      /**
        ...
        */
      def checkMethodOverrides(myClass: Symbols.ClassSymbol, function: Trees.MethodDecl): Unit = {
      ...
      /**
        ...
        */
      def checkFieldDuplication(myClass: Symbols.ClassSymbol, variable: Trees.VarDecl): Unit = {
      ...
      /**
        ...
        */
      def collectVariableInMethods(myClass: Symbols.ClassSymbol, method: Trees.MethodDecl): Unit = {
      ...
      /**
        ...
        */
      def collectArgsInMethods(myClass: Symbols.ClassSymbol, method: Trees.MethodDecl): Unit = {
        myClass.lookupMethod(method.id.value) match {
          case None => sys.error("Method was not declared !")
          case Some(methodSymbol) =>
      ...
      expr match {
        ...
        case New(tpe: Identifier) =>
          gs.lookupClass(tpe.value) match {
            ...
            case Some(classSymbol) => tpe.setSymbol(classSymbol)
           }
